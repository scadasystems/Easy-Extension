...
class AutoSizeText extends StatefulWidget {
  ...
  /// ```
  ///
  /// ![example](https://github.com/scadasystems/Easy-Extension/blob/main/images/auto_size_text/minfontsize.gif?raw=true)
  ///
  const AutoSizeText(
    String this.text, {
    super.key,
  ...
  /// ```
  ///
  /// ![example](https://github.com/scadasystems/Easy-Extension/blob/main/images/auto_size_text/maxlines_rich.gif?raw=true)
  ///
  ...
  const AutoSizeText.selectable(
    ...
    this.scrollPhysics,
    this.onSelectionChanged,
  })  : assert(text != null, 'A non-null String must be provided to a AutoSizeText widget.'),
        textSpan = null,
        locale = null,
        softWrap = null,
        overflow = null,
  ...
  ///
  /// This will be null if [text] is provided instead.
  ...
  /// ```
  ///
  /// ![example](https://github.com/scadasystems/Easy-Extension/blob/main/images/auto_size_text/group.gif?raw=true)
  ///
  ...
  /// ```
  ///
  /// ![example](https://github.com/scadasystems/Easy-Extension/blob/main/images/auto_size_text/overflowreplacement.gif?raw=true)
  ///
